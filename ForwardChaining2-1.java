/**
 * Assignment 2 section 2 task 2: The customer already chose the 3.0 GHz CPU and the small case.  
 * Can the customer choose the discrete GPU as well? 
 */
import java.util.ArrayList;
import java.util.Arrays;
public class ForwardChaining2 {
