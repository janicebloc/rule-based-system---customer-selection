/**
 * Assignment 2 section 2 task 2: My example 1.  The customer already chose the 2.4 GHz CPU, 
 * the 32GB memory, and the large case. Can he also choose the discrete GPU?
 */
import java.util.ArrayList;
import java.util.Arrays;
public class ForwardChaining4 {

	    ArrayList<int[]> clauses;
	    
	    public ForwardChaining4() {
