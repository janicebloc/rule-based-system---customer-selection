/**
 * Assignment 2 section 2 task 2: The customer already chose the 2.4 GHz CPU, 32 GB memory,
 * and the small case.  
 * Can the customer choose the 1 TB disk as well? 
 */
import java.util.ArrayList;
import java.util.Arrays;
public class ForwardChaining3 {

	    ArrayList<int[]> clauses;
	    
	    public ForwardChaining3() {
