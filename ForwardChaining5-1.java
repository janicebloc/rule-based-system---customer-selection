/**
 * Assignment 2 section 2 task 2: My example 2.  The customer chose the 32 GB memory and the 
 * 1 TB disk. May he choose the large case?
 */
import java.util.ArrayList;
import java.util.Arrays;
public class ForwardChaining5 {

	    ArrayList<int[]> clauses;
	    
	    public ForwardChaining5() {
